...
-(UIColor*) touchedColor{
    ...
    if(!_touchedColor){
            _touchedColor = [UIColor colorWithWhite:1. alpha:1];
    }
...
-(UIColor*) storkeColor
{
    ...
    if(!_storkeColor){
        _storkeColor = self.touchedColor;
    }
